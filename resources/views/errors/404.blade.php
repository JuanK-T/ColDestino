...
<html>
<head>
<title>ColDestino 404 Error</title>
<meta charset="utf-8">
...
<body>
<div class="bg-gradient-to-r from-yellow-300 to-blue-200">
...
<button class="bg-gradient-to-r from-yellow-400 to-blue-400 hover:from-pink-500 hover:to-orange-500 text-white font-semibold px-6 py-3 rounded-md mr-6">
HOME
</button>
