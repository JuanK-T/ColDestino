        ...
        <div class="container py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    @livewire('post-reviews', ['post' => $post])
                </div>

                {{-- Contenido Relacionado --}}
                <div x-data="{ atTop: true }"
                    x-on:scroll.window="atTop =( window.pageYOffset > 180) ? false : true ">
                    <div x-bind:class='{ "sticky top-12": !atTop}'>    
                        <aside class="lg:col-span-1 hidden lg:block lg:order-1 order-2">
                        ...
                        {{-- Start of component --}}
                        <section
                        class="order-1 lg:order-2 max-w-sm bg-white border-2 border-gray-300 p-6 rounded-md tracking-wide shadow-lg">
