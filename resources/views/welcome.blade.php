<x-app-layout>
    <section class="bg-cover" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url({{asset('img/home/flavia-carpio-P3PFi8THbUs-unsplash.jpg')}})">
        <div class="container py-36">
            <div class="w-full md:w-3/4 lg:w-1/2">
                <h1 class="text-white font-bold text-6xl">
                    La Mejor Forma de Conocer a Colombia
                </h1>
    ...
    <section class="mt-16">
        <h1 class="text-gray-600 font-light text-center text-5xl">Descubre Colombia</h1>
        <p class="text-gray-500 font-normal text-center text-lg">Estos destinos populares tienen mucho que ofrecer</p>
            {{-- ENVIO INFORMACION AL CONTROLADOR DE LIVEWIRE --}}
            @livewire('tag-sites',['tag' => $tags])
    </section>

    <section class="mt-24 bg-gray-700 py-12">
        <h1 class="text-center text-white text-3xl">¿No sabes que buscar?</h1>
        <h2 class="text-center text-white text-2xl">¡Perfecto!</h2>
    ...
    <section class="mt-24">
        <div class="container py-8">
            <h1 class="text-3xl text-gray-600 mb-4">Inspírate para tu próximo viaje</h1>
