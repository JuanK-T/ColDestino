        ...
        <div class="glider-contain">
            <ul class="glider">
                @foreach($etiquetas as $etiqueta)
                    <li class="mr-4">
                        <figure class="hover:opacity-90 bg-cover bg-center" 
                        style="object-fit: cover;
                            ...
                            background-image: linear-gradient(rgba(0, 0, 0, 0.5), 
                                rgba(0, 0, 0, 0.5)),
                                url(@if ($etiqueta->image)
                                    {{Storage::url($etiqueta->image->url)}}
                                @else
                                    https://cdn.pixabay.com/photo/2016/05/27/00/33/laguna-1418870_960_720.jpg
                                @endif)">
                            <div class="px-2">
