        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative mx-16">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="transition duration-500 text-sm bg-transparent hover:bg-gray-900 text-gray-900 font-semibold hover:text-white py-2 px-4 border border-gray-700 hover:border-transparent rounded">
                            Iniciar sesión
                        </a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="transition duration-500 text-sm bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-2">
                                Registrarse
                            </a>
                        @endif
                    @endauth
